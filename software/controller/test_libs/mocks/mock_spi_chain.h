...
class MockChain : public DaisyChain<MaxSlaves> {
 public:
  ...
  void BlockTransmission() { this->transmitting_data_ = true; }
  ...
  void BlockInterrupts() { manual_interrupts_ = true; }
  ...
  size_t max_queue_length() { return this->MaxQueueLength; }

  size_t FreeCommandBuffer() { return this->CommandBufferSize - this->command_buffer_count_; }
