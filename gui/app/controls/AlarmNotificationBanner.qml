...
/*!
    ...
    \qml
        AlarmNotificationBanner {
            enabled: GuiState.alarmManager.alarmActive
            state: GuiState.alarmManager.alarmPriority
            title: GuiState.alarmManager.alarmText
            alarmsCount: GuiState.alarmManager.alarmsCount
            onPauseAlarmClicked: GuiState.alarmManager.acknowledge()
        }
    \endqml
*/
Item {
    ...
    property int priority: Alarm.None

    signal pauseAlarmClicked()

    state: switch(priority) {
           case Alarm.None: "";   break;
           case Alarm.Low: "low"; break;
           case Alarm.Medium: "medium"; break;
           case Alarm.High: "high"; break;
           }
    ...
    states: [
        State {
            ...
            PropertyChanges {
                target: root;
                bgColor: Style.theme.color.alarmHigh
        ...
        State {
            ...
            PropertyChanges {
                target: root;
                bgColor: Style.theme.color.alarmMedium
        ...
        State {
            ...
            PropertyChanges {
                target: root;
                bgColor: Style.theme.color.alarmLow
                alarm_button_bg: "black"
                alarm_button_fg: "white"
                restoreEntryValues: false
            }
