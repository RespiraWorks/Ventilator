...
Item {
    ...
    property alias fi_DateLabel___selected_color: fi_DateLabel___selected.color
    //TEXTHAL 2
    property alias fi_DateLabel___selected_horizontalAlignment: fi_DateLabel___selected.horizontalAlignment
    //REAL 1
    property alias fi_DateLabel___selected_opacity: fi_DateLabel___selected.opacity
    //TRANSLATABLE 00/0/0000
    property alias fi_DateLabel___selected_text: fi_DateLabel___selected.text
    //TEXTVAL 32
    property alias fi_DateLabel___selected_verticalAlignment: fi_DateLabel___selected.verticalAlignment
    //COLOR buttonAltTextColor
    ...
    //COLOR buttonAltTextColor
    property alias fi_TimeLabel___selected_color: fi_TimeLabel___selected.color
    //TEXTHAL 1
    property alias fi_TimeLabel___selected_horizontalAlignment: fi_TimeLabel___selected.horizontalAlignment
    //REAL 1
    property alias fi_TimeLabel___selected_opacity: fi_TimeLabel___selected.opacity
    //TRANSLATABLE 00:00
    property alias fi_TimeLabel___selected_text: fi_TimeLabel___selected.text
    //TEXTVAL 32
    property alias fi_TimeLabel___selected_verticalAlignment: fi_TimeLabel___selected.verticalAlignment
