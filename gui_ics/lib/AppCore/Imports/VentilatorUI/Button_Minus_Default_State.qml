...
Item {
    ...
    //ASSET /Icons/Minus__DefaultState.png
    ...
    DecorativeSet.DecoratedItem {
        ...
        z: 0
        source: GreenHouseThemeManager.theme.asset("/210_35.png")
        opacity: 1
        enabled: true
        visible: true
        clip: false
    ...
    Image {
        ...
        width: 90
        height: 90
        source: GreenHouseThemeManager.theme.asset("/Icons/Minus__DefaultState.png")
