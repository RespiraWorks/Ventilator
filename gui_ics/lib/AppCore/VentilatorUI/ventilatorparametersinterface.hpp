...
class APPCORE_EXPORT VentilatorParametersInterface : public QObject
{
    ...
    Q_PROPERTY(int currentAdditionalValue READ currentAdditionalValue NOTIFY currentAdditionalValueChanged)
    ...
    Q_PROPERTY(QString batteryPercentageText READ batteryPercentageText NOTIFY batteryPercentageTextChanged)
        QString m_batteryPercentageText = {QStringLiteral("100%")};
    Q_PROPERTY(QString batteryPercentageAsset READ batteryPercentageAsset NOTIFY batteryPercentageAssetChanged)
...
signals:
    ...
    ///
    /// \brief currentAdditionalValueChanged emitted when the currentAdditionalValue property changes
    ///
    ...
    ///
    /// \brief batteryPercentageAssetChanged emitted when the batteryPercentageAsset property changes
    ///
