...
Item {
    ...
    //ASSET /Icons/ArrowUp__DefaultState.png
    ...
    DecorativeSet.DecoratedItem {
        ...
        z: 0
        source: GreenHouseThemeManager.theme.asset("/210_19.png")
        opacity: 1
        enabled: true
        visible: true
        clip: false
    ...
    Image {
        ...
        width: 60
        height: 60
        source: GreenHouseThemeManager.theme.asset("/Icons/ArrowUp__DefaultState.png")
