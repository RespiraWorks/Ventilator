...
class WaveformChartWidget : public QQuickPaintedItem
{
    ...
    Q_PROPERTY(
            FilteredWaveformValueData *filteredData READ filteredData WRITE setFilteredData NOTIFY filteredDataChanged)
    ...
    Q_PROPERTY(QColor gridLabelsColor READ gridLabelsColor WRITE setGridLabelsColor NOTIFY gridLabelsColorChanged)
    ...
    Q_PROPERTY(bool showVerticalGrid READ showVerticalGrid WRITE setShowVerticalGrid NOTIFY showVerticalGridChanged)
    Q_PROPERTY(bool showVerticalGridLabels READ showVerticalGridLabels WRITE setShowVerticalGridLabels NOTIFY
                       showVerticalGridLabelsChanged)
    ...
    Q_PROPERTY(Qt::PenStyle waveformStyle READ waveformStyle WRITE setWaveformStyle NOTIFY waveformStyleChanged)
    Q_PROPERTY(float waveformWidth READ waveformWidth WRITE setWaveformWidth NOTIFY waveformWidthChanged)
