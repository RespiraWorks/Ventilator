...
class RxListener {
 public:
  // Called when the ordered number of bytes is transferred from UART to memory over DMA
...
class TxListener {
 public:
  // Called when the ordered number of bytes is transferred from memory to UART over DMA
