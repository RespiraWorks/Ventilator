...
|**A2** | 1        | RespiraWorks  | internals                |             | [Rw][a1rw]     | Internals assembly - includes most pneumatics, electrical and computing components |
|**A3** | 1        | RespiraWorks  | enclosure                |             | [Rw][a1rw]     | Metal enclosure that contains and protects the ventilator internals |
|**A3** | 1        | RespiraWorks  | cooling_fan_assembly     |             | [Rw][a1rw]     | For removing heat generated by electrical equipment |
|**A3** | 1        | RespiraWorks  | closure_panel            |             | [Rw][a1rw]     | Completes the enclosure and provides power input interface |
|**A8** | 12       | McMaster-Carr  | 92095A188               | 10.04 / 100 | [C][a8mcmc]    | M4 screws, 6mm: main bracket and closure fastening |
|**A3** | 1        | RespiraWorks  | peripherals              |             | [Rw][a1rw]     | Indispensable components that are strictly outside of the assembly itself |
