...
TEST(TraceHandler, Flush) {
  ...
  Context flush_context = {.request = flush_command.data(),
                           ...
                           .response_length = 0,
                           .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&flush_context));
...
TEST(TraceHandler, Read) {
  ...
  Context read_context = {.request = read_command.data(),
                          ...
                          .response_length = 0,
                          .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&read_context));
  EXPECT_TRUE(processed);
  ...
  Context start_context = {.request = start_command.data(),
                           ...
                           .response_length = 0,
                           .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&start_context));
  EXPECT_TRUE(processed);
  ...
  Context num_samples_context = {.request = num_samples_command.data(),
                                 ...
                                 .response_length = 0,
                                 .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&num_samples_context));
  EXPECT_TRUE(processed);
...
TEST(TraceHandler, SettersAndGetters) {
  ...
  Context set_var1_context = {.request = set_var1_command.data(),
                              ...
                              .response_length = 0,
                              .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&set_var1_context));
  EXPECT_TRUE(processed);
  ...
  Context get_var1_context = {.request = get_var1_command.data(),
                              ...
                              .response_length = 0,
                              .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&get_var1_context));
  EXPECT_TRUE(processed);
  ...
  Context get_var2_context = {.request = get_var2_command.data(),
                              ...
                              .response_length = 0,
                              .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&get_var2_context));
  EXPECT_TRUE(processed);
  ...
  Context get_var_max_context = {.request = get_var_max_command.data(),
                                 ...
                                 .response_length = 0,
                                 .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&get_var_max_context));
  EXPECT_TRUE(processed);
  ...
  Context set_period_context = {.request = set_period_command.data(),
                                ...
                                .response_length = 0,
                                .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&set_period_context));
  EXPECT_TRUE(processed);
  ...
  Context get_period_context = {.request = get_period_command.data(),
                                ...
                                .response_length = 0,
                                .processed = &processed};
  EXPECT_EQ(Error_Code_None, trace_handler.Process(&get_period_context));
  EXPECT_TRUE(processed);
