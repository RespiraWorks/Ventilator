...
TEST_F(VentilatorParametersInterfaceInterfaceTest, preUseTestPassed)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::preUseTestPassedChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, showSettings)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::showSettingsChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, acpModeName)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::acpModeNameChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, currentRate)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::currentRateChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, currentPeep)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::currentPeepChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, currentTidalV)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::currentTidalVChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, currentAdditionalValue)
{
    ...
    QObject::connect(iface,
                     &VentilatorUI::VentilatorParametersInterface::currentAdditionalValueChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, powerSourceType)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::powerSourceTypeChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, powerSourceAsset)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::powerSourceAssetChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, batteryPercentageText)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface,
                     &VentilatorUI::VentilatorParametersInterface::batteryPercentageTextChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, batteryPercentageAsset)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface,
                     &VentilatorUI::VentilatorParametersInterface::batteryPercentageAssetChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, batteryLevel)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::batteryLevelChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, alertText)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::alertTextChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, tidalVLow)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::tidalVLowChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, tidalVHigh)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::tidalVHighChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, peepLow)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::peepLowChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, peepHigh)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::peepHighChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, tidalVStep)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::tidalVStepChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, peepStep)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::peepStepChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, rrMinLow)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::rrMinLowChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, rrMinHigh)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::rrMinHighChanged,
                     [&]() { changeSignalEmitted = true; });
...
TEST_F(VentilatorParametersInterfaceInterfaceTest, rrMinStep)
{
    ...
    bool changeSignalEmitted = false;
    QObject::connect(iface, &VentilatorUI::VentilatorParametersInterface::rrMinStepChanged,
                     [&]() { changeSignalEmitted = true; });
