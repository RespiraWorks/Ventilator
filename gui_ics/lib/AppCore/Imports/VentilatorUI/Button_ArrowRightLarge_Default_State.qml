...
Item {
    ...
    //ASSET /Icons/ArrowRight__DefaultState.png
    ...
    DecorativeSet.DecoratedItem {
        ...
        z: 0
        source: GreenHouseThemeManager.theme.asset("/283_1200.png")
        opacity: 1
        enabled: true
        visible: true
        clip: false
    ...
    Image {
        ...
        width: 90
        height: 90
        source: GreenHouseThemeManager.theme.asset("/Icons/ArrowRight__DefaultState.png")
