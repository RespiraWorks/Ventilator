...
Item {
    ...
    //ASSET /Icons/Placeholder__DefaultState.png
    ...
    DecorativeSet.DecoratedItem {
        ...
        z: 0
        source: GreenHouseThemeManager.theme.asset("/133_565.png")
        opacity: 1
        enabled: true
        visible: true
        clip: false
    ...
    Image {
        ...
        width: 60
        height: 60
        source: GreenHouseThemeManager.theme.asset("/Icons/Placeholder__DefaultState.png")
