...
AdjustRRMinLayout {
    ...
    Item {
        ...
        VentilatorUISet.Button_TextPrimary_Default_State {
            ...
            onClicked: {
                root.itemInterface.call_VentilatorParametersInterface_adjustRrMin(VentilatorParametersInterface.rrMinPopup)
        ...
        Text {
            ...
            z: 3
            height: 196
            text: VentilatorParametersInterface.rrMinPopup
        ...
        VentilatorUISet.Button_Minus_Default_State {
            ...
            onClicked: {
                root.itemInterface.set_VentilatorParametersInterface_rrMinPopup(VentilatorParametersInterface.rrMinPopup - VentilatorParametersInterface.rrMinStep)
            }
        }
    ...
    showAnimation: AdjustRRMinLayoutShowAnimation { target: root }
    hideAnimation: AdjustRRMinLayoutHideAnimation { target: root }
    initAction: AdjustRRMinLayoutInitAnimation { target: root }

    itemInterface: AdjustRRMinIFaceImpl {}
}
