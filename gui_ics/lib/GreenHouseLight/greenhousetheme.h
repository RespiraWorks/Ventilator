...
public:
    ...
    /// provided id \param id the requested asset's name/id for example "foobar" \param frame the
    /// number of the requested frame \param frameIdLength the minimum leanght of the frame id
    /// generated from the provided frame number \return
    ///
    ...
    /// specified color \param id the requested asset's name/id for example "foobar.png" \param
    /// colorId the desired color's id for the requested asset, can be ignored if no colored match
    /// is found \return
    ///
    ...
    /// "w_100_h_100_rgb342434" \return a unique asset has id
    ///
...
public:
    ...
    /// provided context \param context \return
    ///
    ...
    /// name \param theme the requested theme's name \param context
    ///
