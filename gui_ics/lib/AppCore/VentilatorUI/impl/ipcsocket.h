...
public:
    ...
    void sendStartPreUseTest()
    {
        sendSimpleParameter(QJsonValue(QStringLiteral("StartPreUseTest")), QJsonValue(QString()));
    };
    void sendSetPressureMode(int mode)
    {
        sendSimpleParameter(QJsonValue(QStringLiteral("SetPressureMode")), QJsonValue(mode));
    };
    void sendSetTidalv(int value)
    {
        sendSimpleParameter(QJsonValue(QStringLiteral("SetTidalv")), QJsonValue(value));
    };
    void sendSetPeep(int value)
    {
        sendSimpleParameter(QJsonValue(QStringLiteral("SetPeep")), QJsonValue(value));
    };
    void sendSetRr(int value)
    {
        sendSimpleParameter(QJsonValue(QStringLiteral("SetRr")), QJsonValue(value));
    };
