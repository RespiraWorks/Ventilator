...
/// \TODO subclass as STM32 and mock classes to make this easier to read, and have the mock class be
//    part of the tests rather than the main code. Maybe factor out oversampling apart from the low
//    level HAL stuff?
...
class ADC {
 public:
  ...
  /// \TODO this should be defined in system constants? passed in as parameter?
