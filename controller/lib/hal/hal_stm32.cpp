...
void HalApi::startLoopTimer(const Duration &period, void (*callback)(void *),
  ...
  // Enable the interrupt that will call the high priority
...
static void Timer15ISR() {
  ...
  // Call the function
  high_priority_callback(high_priority_arg);
}
