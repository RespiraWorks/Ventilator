...
Item {
    ...
    //ASSET /Icons/ArrowDown__DefaultState.png
    ...
    DecorativeSet.DecoratedItem {
        ...
        z: 0
        source: GreenHouseThemeManager.theme.asset("/210_5.png")
        opacity: 1
        enabled: true
        visible: true
        clip: false
    ...
    Image {
        ...
        width: 60
        height: 60
        source: GreenHouseThemeManager.theme.asset("/Icons/ArrowDown__DefaultState.png")
