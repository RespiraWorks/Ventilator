...
AdjustIERatioLayout {
    ...
    Item {
        ...
        VentilatorUISet.Button_ArrowLeftLarge_Default_State {
            id: fi_Button_ArrowLeftLarge
            x: 40
            y: 102
            z: 4
            width: 90
        ...
        VentilatorUISet.Button_ArrowRightLarge_Default_State {
            id: fi_Button_ArrowRightLarge
            x: 496
            y: 102
            z: 5
            width: 90
    ...
    showAnimation: AdjustIERatioLayoutShowAnimation { target: root }
    hideAnimation: AdjustIERatioLayoutHideAnimation { target: root }
    initAction: AdjustIERatioLayoutInitAnimation { target: root }

    itemInterface: AdjustIERatioIFaceImpl {}
}
