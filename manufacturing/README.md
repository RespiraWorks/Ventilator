...
|**A3** | 1        | RespiraWorks  | cooling_fan_assembly     |             | [Rw][a4rw]     | For removing heat generated by electrical equipment |
|**A3** | 1        | RespiraWorks  | closure_panel            |             | [Rw][a5rw]     | Completes the enclosure and provides power input interface |
|**A8** | 12       | McMaster-Carr  | 92095A188               | 10.04 / 100 | [C][a6mcmc]    | M4 screws, 6mm: main bracket and closure fastening |
|**A3** | 1        | RespiraWorks  | peripherals              |             | [Rw][a7rw]     | Indispensable components that are strictly outside of the assembly itself |
