...
AnalogPressureSensor<SourceType>::AnalogPressureSensor(const char *name,
                                                       const char *help_supplement,
                                                       SourceType&& source, float voltage_to_kPa)
    : PressureSensor(name, help_supplement),
      AnalogSensor<SourceType>(name, help_supplement, std::move(source)),
      voltage_to_kPa_(voltage_to_kPa) {}

template <class SourceType>
Pressure AnalogPressureSensor<SourceType>::read() const {
  auto ret = kPa(AnalogSensor<SourceType>::read_diff_volts() * voltage_to_kPa_);
...
template <class SourceType>
MPXV5004DP<SourceType>::MPXV5004DP(const char *name, const char *help_supplement,
                                   SourceType&& source, Voltage voltage_range)
    : AnalogPressureSensor<SourceType>(name, help_supplement, std::move(source), 5.f / voltage_range.volts()) {}
...
// pressure in kPa.
template <class SourceType>
MPXV5010DP<SourceType>::MPXV5010DP(const char *name, const char *help_supplement,
                                   SourceType&& source, Voltage voltage_range)
    : AnalogPressureSensor<SourceType>(name, help_supplement, std::move(source),
