...
Item {
    ...
    //ASSET /Icons/ArrowLeft__DefaultState.png
    ...
    DecorativeSet.DecoratedItem {
        ...
        z: 0
        source: GreenHouseThemeManager.theme.asset("/283_1204.png")
        opacity: 1
        enabled: true
        visible: true
        clip: false
    ...
    Image {
        ...
        width: 90
        height: 90
        source: GreenHouseThemeManager.theme.asset("/Icons/ArrowLeft__DefaultState.png")
