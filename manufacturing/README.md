...
| ----- |---------:| ------------- | ---------------------------- | -----------:|:--------------:|:------|
|**A1** | 1        | RespiraWorks  | [Wiring harnesses][a1rw]     |             | Rw             | Wiring harnesses: have these ready to be integrated into below assemblies |
|**A2** | 1        | RespiraWorks  | [Internals][a2rw]            |             | Rw             | Internals assembly - includes most pneumatics, electrical and computing components |
|**A3** | 1        | RespiraWorks  | [Enclosure][a3rw]            |             | Rw             | Metal enclosure that contains and protects the ventilator internals |
|**A4** | 1        | RespiraWorks  | [Cooling fan assembly][a4rw] |             | Rw             | For removing heat generated by electrical equipment |
|**A5** | 1        | RespiraWorks  | [Closure panel][a5rw]        |             | Rw             | Completes the enclosure and provides power input interface |
|**A6** | 12       | McMaster-Carr | 92095A188                    | 10.04 / 100 | [C][a6mcmc]    | M4 screws, 6mm: main bracket and closure fastening |
|**A7** | 1        | RespiraWorks  | [Peripherals][a7rw]          |             | Rw             | Indispensable components that are strictly outside of the assembly itself |
